...
**2023/01/25 付けで Twitter アカウントの ID を <a href="https://twitter.com/Nch_MOSFET">@Nch_MOSFET</a> から <a href="https://twitter.com/53175DDD">@53175DDD</a> に変更しました。元の ID はリンク切れ防止を兼ねてサブ垢用に使用しています。ご注意ください**
...
　基本的に行いませんが、万が一、フォローしていたアカウントが電子工作をしなくなったり、関わりがなくなったり、過激な発言が目立つなど、フォローしている意味がなくなった場合は、こちらからフォローを解除することがあります
...
　ごく普通のコミュニケーションとして返信する場合があります。何かしらの反応をいただけますと嬉しいです
...
　また、DM は常時開放していますので私に対して何か相談や質問等の用事がある場合はぜひご利用ください
...
　2023/01/20 時点で メインの PC での Twitter クライアントを [TweetDeck](https://tweetdeck.twitter.com/) に移行するに伴い、タイムライン整理を兼ねて特定の分野ごとにリストを作成しました。そのため、フォローされていないのに通知が来るということが増える場合がありますが、何かしらのリストに入れられていることがほとんどだと思います  
...
<div align="center">© MOS 2023│CC BY-NC-ND 4.0</div>
